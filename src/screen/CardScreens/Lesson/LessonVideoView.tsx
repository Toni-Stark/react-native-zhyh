...
type ScreenRouteProp = RouteProp<ScreensParamList, 'LessonVideoView'>;
type Props = {
  route: ScreenRouteProp;
};

export const LessonVideoView: React.FC<NavigatorComponentProps & Props> = observer(
              ...
              <View style={[tw.absolute, { height: fullScreen ? Dimensions.get('screen').width : vodHeight, width: '100%' }]}>
                    ...
                    >
                      <View style={[tw.flex1, tw.justifyAround]}>
                        {speedList.map((item, index) => (
                          <Text
                            style={[tw.flex1, { color: colors.background, fontSize: 12 }]}
                            key={index}
                            onPress={() => {
                              setRate(item);
                              timeFadeOut();
                ...
                >
                  <View style={[tw.wFull, { height: 40 }]}>
                    ...
                    <View style={[tw.itemsCenter, tw.absolute, { width: 45, right: 35, bottom: 14 }]}>
                      <TouchableOpacity
