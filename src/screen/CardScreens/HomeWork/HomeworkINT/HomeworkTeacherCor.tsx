...
type ScreenRouteProp = RouteProp<ScreensParamList, 'HomeworkTeacherCor'>;

type Props = {
  route: ScreenRouteProp;
};

export const HomeworkTeacherCor: React.FC<NavigatorComponentProps & Props> = observer(
        ...
        if (content && content.length <= 0) {
          ...
          if (homeworkCreateStore.allFileList.length > 0) {
            const res = await homeworkCreateStore.uploadForAliOSS({
              ...
              content: content,
              lectureId: homeworkInterStore.homeworkInfoDetail.id,
            ...
            homeworkCreateStore
              ...
              .then((subRes) => {
                ...
                if (typeof subRes === 'boolean') {
                  ...
                  baseView.current.showMessage({ text: subRes, delay: 2 });
                }
              });
          }
        }
          ...
          <View style={[tw.pX3, { backgroundColor: colors.background }]}>
            ...
            >
              <UselessTextInput
                ...
                value={content}
              />
              <View style={[tw.borderGray200, { borderBottomWidth: 0.5 }]}>
                <Text style={[{ color: colors.placeholder }]}>学生附件（无法更改）：</Text>
                <View>
    ...
    return (
      <BaseView useSafeArea={false} scroll={false} ref={baseView} style={[tw.flex1]}>
        <Appbar.Header style={{ backgroundColor: colors.background }}>
          ...
          />
          <Appbar.Content title={homeworkInterStore.homeworkInfoDetail.student?.username} />
        </Appbar.Header>
